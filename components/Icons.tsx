...
export const MusicNoteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path d="M7 4a1 1 0 011-1h3a1 1 0 011 1v2.336A3.003 3.003 0 0112 10a3 3 0 11-3-3V4z" />
        <path d="M3 13.065V5.5A2.5 2.5 0 015.5 3h6A2.5 2.5 0 0114 5.5v2.836A3.002 3.002 0 0112 10a3 3 0 11-4.898 2.065" />
    </svg>
);
